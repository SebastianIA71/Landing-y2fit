...
export default function WaitlistForm() {
  ...
  return (
    <form
      ...
      className="mx-auto mt-10 grid max-w-[760px] gap-3 rounded-[28px] border border-ink/10 bg-ink p-4 text-left shadow-[0_28px_70px_rgba(0,0,0,.22)] sm:grid-cols-2 sm:p-5"
    >
      <label className="block">
        <span className="mb-2 block text-[11px] font-bold uppercase tracking-[.16em] text-white/45">
          Nombre
        </span>
        <input
          type="text"
          ...
          className="h-[52px] w-full rounded-2xl border border-white/[.08] bg-white/[.06] px-4 text-[15px] font-semibold text-fog outline-none transition placeholder:text-white/25 focus:border-volt/60"
        />
      </label>
      ...
      <label className="block">
        ...
        <select
          ...
          className="h-[52px] w-full rounded-2xl border border-white/[.08] bg-white/[.06] px-4 text-[15px] font-semibold text-fog outline-none transition focus:border-volt/60"
        >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="min-h-[56px] rounded-2xl bg-volt px-6 font-display text-[15px] font-black uppercase tracking-wide text-ink transition hover:bg-acid disabled:cursor-not-allowed disabled:opacity-70 sm:col-span-2"
      >
