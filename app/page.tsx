...
const features = [
  {
    ...
    text: "Sesiones cortas, visuales y con objetivo claro para saber qué toca antes de entrar al gym."
  },
  {
    title: "Progreso que engancha",
    text: "Rachas, niveles y mejoras visibles para que cada semana se sienta como una nueva temporada."
  },
  {
    title: "Transición sin caos",
    text: "Guía el salto del deporte de equipo al gym sin tecnicismos ni dudas sobre por dónde empezar."
  },
  {
    title: "Look deportivo real",
    text: "Una interfaz oscura, rápida y directa pensada para usar entre clase, entreno y amigos."
  }
];
...
const steps = [
  ...
  "Sube de nivel y desbloquea progreso"
];

const benefits = [
  "Menos dudas al entrar al gym",
  "Más constancia sin depender de la motivación",
  "Rutinas pensadas para cuerpos jóvenes",
  "Sensación de equipo aunque entrenes solo",
  "Progreso fácil de enseñar y compartir",
...
const testimonials = [
  {
    quote:
      "Dejé el fútbol y no sabía ni por dónde empezar. Y2FIT me dio una rutina sin hacerme sentir perdido.",
    name: "Alex, 18"
  },
  {
    quote:
      "Parece una serie. Cada semana tenía algo nuevo que completar y eso me mantuvo dentro.",
    name: "Nora, 20"
  },
  {
    quote:
      "No quería una app de culturismo. Quería algo directo, visual y con energía.",
    name: "Dani, 17"
  }
];
...
export default function Home() {
  return (
    <main className="relative isolate overflow-hidden bg-ink text-fog">
      ...
      <section id="inicio" className="relative min-h-screen overflow-hidden pt-28 sm:pt-32">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 pb-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:pb-24">
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted sm:text-xl">
              Y2FIT convierte el primer gym en una experiencia guiada, visual y motivadora para jóvenes que vienen del deporte de equipo y quieren seguir progresando.
            </p>
            <div className="mt-8">
              <ButtonRow />
            </div>
            <div className="mt-10 grid max-w-xl grid-cols-3 gap-3">
              {['+42%', '3 pasos', '0 caos'].map((item, index) => (
                <div key={item} className="border-l border-white/12 pl-4">
                  <p className="font-display text-2xl font-black text-fog">{item}</p>
                  <p className="mt-1 text-xs uppercase tracking-wide text-muted">
                    {index === 0 ? "retención objetivo" : index === 1 ? "onboarding" : "primera semana"}
                  </p>
                </div>
              ))}
            </div>
          ...
          >
            ...
            <Image
              ...
              alt="Mockup móvil de la app Y2FIT"
              width={760}
              height={920}
              priority
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="font-display text-4xl font-black uppercase leading-tight text-fog sm:text-5xl">
              Cuando acaba el equipo, empieza el vacío.
            </h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              "Sin mapa para saber si estás mejorando."
            ].map((text) => (
              <div key={text} className="rounded-md border border-white/10 bg-white/[0.035] p-5">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 sm:px-8 lg:grid-cols-2">
          <div>
            ...
            <h2 className="font-display text-4xl font-black uppercase leading-tight text-fog sm:text-6xl">
              Una transición guiada, motivadora y visual.
            </h2>
            <p className="mt-6 text-lg leading-8 text-muted">
              Y2FIT no intenta parecer una hoja de ejercicios. Ordena el cambio con diagnóstico simple, entrenos por episodios, objetivos de semana y feedback visual para que el usuario sienta avance desde el primer día.
            </p>
            <div className="mt-8">
              <ButtonRow />
            </div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
            <h2 className="max-w-3xl font-display text-4xl font-black uppercase leading-tight sm:text-6xl">
              Todo lo que empuja a volver mañana.
            </h2>
            <p className="max-w-sm text-base leading-7 text-black/60">
              Features enfocadas en conversión, retención y una experiencia que se siente nativa para una audiencia joven.
            </p>
          </div>
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="mt-8 text-xl font-black uppercase">{feature.title}</h3>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {steps.map((step, index) => (
              <div key={step} className="relative rounded-md border border-white/10 bg-ink p-7">
                <span className="font-display text-7xl font-black text-white/8">{index + 1}</span>
                <h3 className="mt-8 text-2xl font-black uppercase text-fog">{step}</h3>
                <p className="mt-4 leading-7 text-muted">
                  {index === 0
                    ? "Responde unas preguntas rápidas y aterriza en un plan adaptado a tu punto de forma."
                    : index === 1
                      ? "Cada entreno tiene estructura clara, foco visual y sensación de capítulo completado."
                      : "Consulta progreso, rachas y próximos retos para mantener la energía de competición."}
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="font-display text-4xl font-black uppercase leading-tight text-fog sm:text-5xl">
              Más claro. Más constante. Más tuyo.
            </h2>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            {benefits.map((benefit) => (
              <div key={benefit} className="flex items-center gap-3 rounded-md border border-white/10 bg-white/[0.035] p-4">
      ...
      <section id="stores" className="relative overflow-hidden py-20 sm:py-28">
        ...
        <div className="mx-auto max-w-5xl px-5 text-center sm:px-8">
          ...
          <h2 className="mt-5 font-display text-5xl font-black uppercase leading-[0.92] text-balance text-fog sm:text-7xl">
            Tu próximo entreno empieza en una descarga.
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted">
            Sustituye estos botones por los enlaces reales cuando la app esté publicada. La landing ya está orientada a conversión.
          </p>
